...
let secretUsername = ("Isaac");
let secretPassword = ("White");
...
button.addEventListener("click", function() {
    ...
    if (username === secretUsername && password === secretPassword) {
        ...
        message.innerHTML = "Incorect username or password. Please try again.";
    if else username !== secretUsername && password === secretPassword) {
